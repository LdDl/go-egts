...
func TestIdentity(t *testing.T) {
	...
	if authCode != 0 {
		t.Errorf("Auth code should be 0, but got %d", authCode)
	}

	resp := parsedAuth.PrepareAnswer()
	encodedResp := resp.Encode()
	hexResp := hex.EncodeToString(encodedResp)
	trueResp := "0100030b001000000000b300000006000000580101000300000000d9d1"
	if hexResp != trueResp {
...
func TestIncomingPacket(t *testing.T) {
	...
	egtsAuthHex = ""
